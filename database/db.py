...
companies = ['MMM', 'AOS', 'ABT', 'ABBV', 'ACN', 'ADBE', 'AMD', 'AES', 'AFL', 'A', 'APD',
...
# Создание таблицы "companies" с автоинкрементом для id_company
...
# Заполнение таблицы значениями из списка
for company in companies:
    cursor.execute("INSERT INTO companies (name_company) VALUES (?)", (company,))
...
# Подтверждение и завершение транзакции
conn.commit()
conn.close()
